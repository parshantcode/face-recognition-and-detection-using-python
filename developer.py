...
class Developer:
    def __init__(self, root):
        ...
        dev_label = Label(main_frame, text="Contact: 6206034775", font=("times new roman",16, "bold"), bg="white")
        dev_label.place(x=0,y=125)


        img_top2 = Image.open(r"./college_images/kiran.jpg")
        ...
        img_top3 = Image.open(r"./college_images/kiran.jpg")
        ...
        img_top4 = Image.open(r"./college_images/kiran.jpg")
