    ...
    def face_recog(self):
        def draw_boundary(img, classifier, scaleFactor, minNeighbors, color, text, clf):
            ...
            for (x, y, w, h) in features:
                ...
                my_cursor.execute(
                    "select email from student where id="+str(id))
                e = my_cursor.fetchone()
                e = "+".join(e)


                my_cursor.execute(
                    "select roll from student where id="+str(id))
                ...
                my_cursor.execute(
                    "select dep from student where id="+str(id))
